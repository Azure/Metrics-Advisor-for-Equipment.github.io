...
![Subject Matter Expertises (SMEs) are highly recommended to be involved in feature selection, model evaluation, and ongoing alert monitoring processes.](/image/High_level_workflow_RAI.png?raw=true "Recommended pilot and production workflow")
